    ...
    if (objects.length > 0) {
        ...
        items.push({
            ...
            onClicked: () => {
                ...
                // find the event path
                var eventPathsToRemove = objects.map((object) =>
                    object.getPath(),
                );

                eventPathsToRemove.forEach((eventPath) => {
        ...
        items.push({
            ...
            onClicked: function () {
                ...
                //find the event path
                var eventPaths = objects.map((object) => object.getPath());
                ...
                eventPaths.forEach((eventPath) => {
                    ...
                    try {
                        ...
                        studio.system.message(
                            "Error adding bank to event: " + e.message,
                        );
                    }
                });
            },
